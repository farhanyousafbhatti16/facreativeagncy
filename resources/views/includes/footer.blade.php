        ...
        <div class="container mil-p-120-60">
            <div class="row justify-content-between">
                <div class="col-md-4 col-lg-4 mil-mb-60">
                    ...
                    <div class="mil-muted mil-logo mil-up mil-mb-30">F&A Creative Agency.</div>
                    ...
                    <div class="row justify-content-end">
                        ...
                        <div class="col-md-6 col-lg-5">
                            ...
                            <ul class="mil-menu-list mil-up mil-mb-60">
                                <li><a  class="mil-light-soft">Privacy Policy</a></li>
                                <li><a  class="mil-light-soft">Terms and conditions</a></li>
                                <li><a  class="mil-light-soft">Cookie Policy</a></li>
            ...
            <div class="row justify-content-between flex-sm-row-reverse">
                ...
                <div class="col-md-4 col-lg-6 mil-mb-60">
                    ...
                    <div class="mil-vert-between">
                        ...
                        <p class="mil-light-soft mil-up">© Copyright 2025 - F&A. All Rights Reserved.</p>
                    </div>
